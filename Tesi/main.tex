...
% Gestione numerazione sezioni, e cosa va nell'indice
\setcounter{secnumdepth}{3}	% subsubsections are numbered
\setcounter{tocdepth}{2}	% table of content shows sections and subsections
...
\include{Varie/Introduction}	% Introduzione e notazione
...
\include{Capitoli/Chapter4}		% Algoritmo di Fasi e Higham

\include{Capitoli/Chapter6}		% Sperimentazioni numeriche
	
\phantomsection
\addcontentsline{toc}{chapter}{Conclusions}
\include{Varie/Conclusions}		% Conclusioni
